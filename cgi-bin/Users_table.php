...
if($result->num_rows > 0){
	...
	<div id="header">
		<div id="top_area">
			<div id="logo_bar">Users Table</div>
		</div>
	</div>
	<br>
	<br>
...
?>
      <tr>
          ...
          <td><?php echo $res['authority_level']?></td>
...
echo "<div style ='font:40px Arial,tahoma,sans-serif;color:#123f87'>Cannot find data in Users table</div>";
}
?>
