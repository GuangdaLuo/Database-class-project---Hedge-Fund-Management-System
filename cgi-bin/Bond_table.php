...
if($result->num_rows > 0){
	...
	<div id="header">
		<div id="top_area">
			<div id="logo_bar">Bond Table</div>
		</div>
	</div>
	<br>
	<br>
...
?>
      <tr>
          <td><?php echo $res['bond_id']?></td>
          <td><?php echo $res['maturity']?></td>
      </tr>

<?php
}
} else {
echo "<div style ='font:40px Arial,tahoma,sans-serif;color:#123f87'>Cannot find data in Bond table</div>";
}
?>
