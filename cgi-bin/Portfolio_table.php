...
if($result->num_rows > 0){
	...
	<div id="header">
		<div id="top_area">
			<div id="logo_bar">Portfolio Table</div>
		</div>
	</div>
	<br>
	<br>
...
?>
      <tr>
          ...
          <td><?php echo $res['cash_amount']?></td>
          <td><?php echo $res['performance_fee']?></td>
          <td><?php echo $res['management_fee']?></td>
      </tr>

<?php
}
} else {
echo "<div style ='font:40px Arial,tahoma,sans-serif;color:#123f87'>Cannot find data in Portfolio table</div>";
}
?>
